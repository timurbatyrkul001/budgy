...
/// Новичкам (нет конвертов и онбординг не пройден) — выбор стартовых
/// конвертов, остальным — сразу главный экран.
class _OnboardingGate extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (done.isLoading || envelopes.isLoading) return const _Splash();
